...
export const metadata = {
  title: "Why Join Us - Sri Ramakrishna Matriculation Higher Secondary School",
  description:
    "Dear students, welcome to our School&lsquo;s virtual space. Here, we strive to create an environment that nurtures your dreams and empowers you to excel. Embrace opportunities, ignite your passion, and together lsquo;s embark on a transformative journey of knowledge, growth, and success. Best wishes for an enriching academic experience!",
};
      ...
      <div className="border-t-4 border-primary-regular p-4 shadow-lg my-4 rounded-md">
        ...
        <div className="grid gap-4 text-xl my-4 px-2">
          <p>
            ...
            School has a vibrant campus life with a wide range of opportunities
            to fill your free time.
          </p>
          <p>
            The School has an impressive and pollution-free campus with
            panoramic green surroundings, elegant landscaping and beautiful
            flower-beds.
          </p>
          <p>
            The School has separate individual departments for all subjects
            with young, dynamic faculty and non-teaching staff and with good
            results.
          </p>
          <p>
            The School has the most eminent Faculty members and they are really
            well qualified, experienced and truly committed towards enhancement
            and development of the students.
          </p>
          <p>
            The School has well-equipped with modern facilities like library,
          ...
          <p>
            ...
            available for the smooth conduct of different classes in the School
          </p>
          <p>
            The School has a library with a good number of books (both text and
          ...
          <p>
            The School runs a canteen inside the campus where staff and
          ...
          <p>
            The School has a large playground with will-equipment for different
            sports like Cricket, Football, Volleyball, Hockey, Badminton and so
            on
          </p>
          <p>
            A medical facility has been available in the School for the benefit
            of the students
          </p>
          <p>
          ...
          <p>
            The School also organizes workshops, seminars, and conferences for
            improving teaching skills and methodology
          </p>
          <p>
            The School also provides NCC training to its students. The NCC
            cadets attend different camps and earn pride for themselves and for
            the School
          </p>
          <p>
            The School has N.S.S. units in the School, Students may take part
          ...
          <p>
            The School consists Women Cell to help female students. This cell
